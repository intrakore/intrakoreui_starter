# Intrakore UI Starter

This template should help get you started developing custom frontend for Intrakore
apps with Vue 3 and the Intrakore UI package.
...
This boilerplate sets up Vue 3, Vue Router, TailwindCSS, and Intrakore UI out of
the box. It also has basic authentication frontend.

## Docs

[Intrakore UI Website](https://intrakoreui.com)

## Usage

This template is meant to be cloned inside an existing Intrakore App. Assuming your
...
The development server is configured to proxy your intrakore app (usually running on port `8000`). If you have a site named `todo.test`, open `http://todo.test:8080` in your browser. If you see a button named "Click to send 'ping' request", congratulations!
...
- [Intrakore UI](https://github.com/intrakore/intrakore-ui)
